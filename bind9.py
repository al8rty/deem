...
def setup_zones():
    ...
    if not os.path.exists(zones_dir):
        ...
        zones_file = {
            "db.work-group.ru": "https://github.com/al8rty/bind9/db.work-group.ru",
            "db.192.0.2": "https://github.com/al8rty/bind9/db.192.0.2"
        }
...
def confirm_bind9():
    ...
    config_url = "https://github.com/al8rty/bind9/named.conf.local"
